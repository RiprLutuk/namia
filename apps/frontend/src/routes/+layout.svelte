...
<svelte:head>
  ...
  <meta
    name="description"
    content="Temukan pilihan pendanaan dan pembiayaan usaha syariah di Namia. Bandingkan produk, hitung kebutuhan, dan siapkan pengajuan Anda."
  />
  <!-- Auto-discovery for RSS 2.0 and Sitemap -->
  <link
    rel="alternate"
    type="application/rss+xml"
    title="Namia Syariah — Sindikasi RSS 2.0"
    href="/rss.xml"
  />
  <link
    rel="sitemap"
...
{:else}
  ...
  <div
    class="public-site min-h-screen flex flex-col relative"
  >
