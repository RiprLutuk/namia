...
INSERT INTO `missions` VALUES (1,'Visi Kami','Menjadi perusahaan berkelas dunia pada bidang teknologi finansial berbasis syariah','icon-group','#1abc9c'),(2,'Misi Kami','<ul><li>Memanusiawikan Layanan Finansial</li><li>Memberikan langkah yang mudah untuk memenuhi kebutuhan konsumen</li><li>Memberikan layanan terbaik melalui peningkatan kualitas dalam semua aspek operasional</li></ul>','icon-cog','#34495e'),(3,'Nilai Perusahaan','<ul><li>Ibadah</li><li>Kepercayaan</li><li>Kebahagiaan</li></ul>','icon-thumbs-up','#e74c3c');
...
INSERT INTO `single_content` VALUES (1,'company quote','Sebaik-baik Manusia adalah yang Paling Berguna Bagi Sesamanya'),(2,'syarfi_address','<strong>PT. Syarfi Teknologi Finansial</strong>\r\n<br> Menara MTH 10th floor\r\n<br> Jl. MT Haryono Kav 23\r\n<br> Jakarta 12820\r\n<br>'),(3,'syarfi_phone','(+62) 21 8378 2337'),(4,'syarfi_fax','(+62) 21 8378 2338'),(5,'syarfi_email','salam@syarfi.id'),(6,'about_title_id','Dokumentasi Kegiatan Syarfi'),(7,'about_subtitle_id','Dokumentasi Kegiatan PT. Syafi Teknologi Digital'),(8,'blog_main_title_en','Syarfi Blog'),(9,'blog_main_sub_en','This Blog contents created by Syarfi team'),(10,'syarfi_facebook','https://www.facebook.com/Syarfi-472466949792782/'),(11,'syarfi_instagram','https://www.instagram.com/syarfi.id/'),(12,'syarfi_twitter','https://twitter.com/Syarfi_ID'),(13,'quote_origin','HR. Ahmad');
...
INSERT INTO `user` VALUES (1,'syarfia@syarfi.com','a2941009d74d8b549edb773418779200','syarfia',1);
...
-- Dump completed on 2018-08-23 16:24:07
